...
export const INITIAL_LOG: LogEntry[] = [
  ...
  {
    ts: "2026-06-14T08:04:38Z",
    event: "Joint public key published to bulletin board",
  },
  {
    ts: "2026-06-14T18:00:00Z",
    event: "Ballot collection closed; 1,247 ballots sealed",
  },
  {
    ts: "2026-06-14T18:02:11Z",
    event: "Trustee 01 — Submitted partial decryption",
  },
  {
    ts: "2026-06-14T18:05:47Z",
    event: "Trustee 02 — Submitted partial decryption",
  },
];
